...
- [캡틴판교님 블로그 슬롯 관련 글](joshua1988.github.io/web-development/vuejs/slots/#slot)

: 슬롯(Slot)이란 컴포넌트의 `재사용성`을 높여주는 기능으로, 하위 컴포넌트의 마크업을 확장하거나 재정의할 수 있는 유용한 기능입니다. (`구현을 사용하는 컴포넌트에서 직접 정의할 수 있습니다.`)

### 컴포넌트간 통신

#### [Vue 컴포넌트](kr.vuejs.org/v2/guide/components.html)
...
<b>사용이 쉽고, 재활용하기 어렵지 않은 컴포넌트를 만드는게 목적이었기 때문에 재활용할 부분과 공통적으로 정의할 내용을 분리하는 것이 중요하다고 생각했습니다.</b>
...
- [Vue Slot](https://kr.vuejs.org/v2/guide/components-slots.html#%EC%BB%B4%ED%8C%8C%EC%9D%BC%EB%90%A0-%EB%95%8C%EC%9D%98-%EB%B2%94%EC%9C%84-Compilation-Scope)
